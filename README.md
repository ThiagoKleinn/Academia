...
4. Executar o arquivo seed.sql
5. Executar as consultas presentes em views.sql
6. Executar as consultas presentes em functions.sql
7. Executar as consultas presentes em queries.sql
